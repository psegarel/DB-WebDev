<?php
// $Id: views-slideshow-ddblock.tpl.php,v 1.3 2010/03/29 03:54:14 ppblaauw Exp $
...
drupal_add_css($directory . '/custom/modules/views_slideshow_ddblock/views-slideshow-ddblock-cycle-vsd-default.css', 'template', 'all', FALSE);
  drupal_set_message('<pre>' . t('path_to_themes => @path_to_themes', array('@path_to_themes' => var_export($directory, TRUE))) . '</pre>');
