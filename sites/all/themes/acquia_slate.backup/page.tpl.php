...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>">
  ...
  <head>
    ...
    <![endif]-->
    <?php print $scripts; ?>
     <link rel="stylesheet" href="<?php print $base_path . $directory; ?>/others.css" type="text/css">
     <script type="text/javascript" src="<?php print $base_path . $directory; ?>/others.js"></script>
  </head>
